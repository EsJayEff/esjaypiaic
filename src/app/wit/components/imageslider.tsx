...
import { VStack,AspectRatio,Box,Flex, Text,HStack, Heading, Link,Img,Grid,GridItem,Image} from "@chakra-ui/react";
...
return (
    ...
    className="relative group" bg="whiteAlpha.900">
...
<Flex flexDirection="column"  height="full" >
   <Box    w="full" >
   <Grid templateColumns={{lg:"repeat(1, 1fr)",md:"repeat(1, 1fr)", base:"repeat(1, 1fr)"}} pb="20px" gap="10" className="relative group px-4 py-16 w-full m-auto">
<GridItem boxShadow='dark-lg' rounded='md'>
         <AspectRatio ratio={16/9} className="w-full h-full  bg-center bg-cover duration-500" >
